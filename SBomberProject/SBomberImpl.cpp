...
void SBomberImpl::CheckDestroyableObjects(BombDecorator* pBomb)
{
...
std::vector<DestroyableGroundObject*> SBomberImpl::FindDestroyableGroundObjects() const
{
...
std::vector<BombDecorator*> SBomberImpl::FindAllBombs() const
{
...
void SBomberImpl::CommandExecuter(std::unique_ptr<Command> command)
{
   if (command)
   {
      command->Execute();
